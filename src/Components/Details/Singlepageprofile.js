  ...
  return (
    <>
      <div className="container-fluid">
        ...
        <div className="row mt-3 main_profile_row">
          <div className="col-lg-6 user_details_section">
            ...
            <h4 className="text-capitalize">
              ...
              <br /> {profileData.city_name} {profileData.state_name}
            </h4>
          </div>
        ...
        <div className="row justify-content-center mb-4">
          <h2 className="personal_details_div_title">
        ...
        <div className="row justify-content-center mb-4">
          ...
          <div className="col-lg-5">
            <p className="fs-5 mt-2">
              <b>Caste :</b> {profileData.caste_pref}
            </p>
            <p className="fs-5 mt-2">
          ...
          <div className="col-lg-5">
            <p className="fs-5 mt-2">
              <b>Height :</b> {profileData.height_pref}
            </p>
          </div>
          ...
          <div className="col-lg-5">
            ...
            <p className="fs-5 mt-2">
              <b>State :</b> {profileData.state_pref}
            </p>
          </div>
        </div>
